...
///
/// ** See code in examples/utills/lib/material/dropdown/dropdown_button.0.dart **
/// {@end-tool}
///
...
class DropdownButton2<T> extends StatefulWidget {
  ...
  ///
  /// ** See code in examples/utills/lib/material/dropdown/dropdown_button.selected_item_builder.0.dart **
  /// {@end-tool}
  ///
  ...
  ///
  /// ** See code in examples/utills/lib/material/dropdown/dropdown_button.style.0.dart **
  /// {@end-tool}
  ///
